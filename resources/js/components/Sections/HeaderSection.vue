            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <nav class="navbar navbar-expand-lg db-navbar">
                        <div class="db-navbar-brand"><a class="navbar-brand" href="index.html"> <img src="../../../images/primary-white-logo.png" alt=""></a></div>
                            ...
                            <ul class="navbar-nav ml-auto mt-2 mt-lg-0 mr-3">
                                ...
                                <li class="nav-item dropdown dropleft user">
                                    <a class="nav-link dropdown-toggle" href="#" id="menu-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="../../../images/avatar-1.jpg" alt="" class="rounded-circle user-profile">
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="menu-2">
                                        <span class="with-arrow"><span class=""></span></span>
                                        <li class="dropdown-item">
                                            <router-link to="/overview" class="dropdown-link" active-class="">
                                                <i class="fas fa-fw fa-tachometer-alt"></i>Overview
                                            </router-link>
                                        </li>
                                        <li class="dropdown-item">
                                            <router-link to="/reservations" class="dropdown-link" active-class="">
                                                <i class="fas fa-fw fa-list"></i>Reservations
                                            </router-link>
                                        </li>
                                        <li class="dropdown-item">
                                            <router-link to="/rooms" class="dropdown-link" active-class="">
                                                <i class="fas fa-fw fa-building"></i>Rooms
                                            </router-link>
                                        </li>
                                        <li class="dropdown-item">
                                            <router-link to="/users" class="dropdown-link" active-class="">
                                                <i class="fas fa-fw fa-user"></i>Users
                                            </router-link>
                                        </li>
                                        <li class="dropdown-item">
                                            <router-link to="/profile" class="dropdown-link" active-class="">
                                                <i class="fas fa-fw fa-cogs"></i>Settings
                                            </router-link>
                                        </li>
                                        <li class="dropdown-item">
                                            <a class="dropdown-link" href="javascript:void(0)" v-on:click.prevent="logout"><i class="fas fa-fw fa-sign-out-alt"></i>Logout</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
